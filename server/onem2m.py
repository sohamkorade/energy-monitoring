...
def create_ae(uri_cse, ae_name, ae_labels="", data_format="json"):
    ...
    try:
        ...
        response = requests.post(uri_cse,
...
def create_desc_cin(uri_desc_cnt,
                    node_description,
                    desc_cin_labels="",
                    data_format="json"):
    """
    ...
    try:
        ...
        response = requests.post(uri_desc_cnt,
                                 data=json.dumps(body),
                                 headers=headers)
    print('Return code : {}'.format(response.status_code))
    print('Return Content : {}'.format(response.text))
...
def create_data_cin(uri_cnt, value, cin_labels="", data_format="json"):
    ...
    try:
        ...
        response = requests.post(uri_cnt,
                                 data=json.dumps(body),
                                 headers=headers)
    print('Return code : {}'.format(response.status_code))
    print('Return Content : {}'.format(response.text))
